...
public class MergeSort {
    ...
    private static <Item extends Comparable> Queue<Queue<Item>>
        ...
        while (!items.isEmpty()) {
            Queue<Item> next = new Queue<>();
            next.enqueue(items.dequeue());
            singles.enqueue(next);
        }
        return singles;
    }
    ...
    public static <Item extends Comparable> Queue<Item> mergeSort(
        ...
        while (singles.size() > 1) {
            Queue<Item> q1 = singles.dequeue();
            Queue<Item> q2 = singles.dequeue();
            Queue<Item> merged = mergeSortedQueues(q1, q2);
            singles.enqueue(merged);
        }

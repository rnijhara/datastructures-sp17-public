...
public class OperationSequence {
    ...
    public void quickAdd(String op) {
        DequeOperation dequeOp = new DequeOperation(op);
        opSequence.addLast(dequeOp);
    }

    public void quickAdd(String op, int arg) {
        DequeOperation dequeOp = new DequeOperation(op, arg);
        opSequence.addLast(dequeOp);
    }
